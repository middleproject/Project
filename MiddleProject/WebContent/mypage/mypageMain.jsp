               ...
               <form id=""   >
                  ...
                  <h1 > ${vo.name } 의 마이페이지 </h1>
					...
					<a href="../recipe/wishRecipe.do" type="button" class="btn">확인하기</a>
                     ...
                     <div class="float-unit"  ><p class="font" >캐시 충전<p>
                     <div class="w-100"></div>
                     <img src="images/money.jpeg" alt="My Image" width="100px" height="100px">
                     <p> 보유한 캐시 ${vo.pay }원<p>
                     <a href="../member/cashPage.do" type="button" class="btn">충전하기</a>
                     </div>
                     ...
                     <div class="w-100"></div>
                     <img src="images/bye.png" alt="My Image" width="100px" height="100px">
                     <p>잘가세요 <p>
