							...
							new daum.Postcode(
									{
										oncomplete : function(data) {
											...
											if (data.userSelectedType === 'R') {
												...
												document
														.getElementById("exAddr").value = extraAddr;

											} else {
												document
														.getElementById("exAddr").value = '';
											}
						...
						<div class="row align-items-end">
							...
							<div class="col-md-10">
								<div class="form-group" style="margin-top: -5px;">
									...
									<label style="position: relative; right: -227px; top: -33px;">*영문/숫자를
										조합하여 최소 6자이상 13이내 대소문자 구별</label> <input type="text" class="textbox"
										id="id" name="id"
										style="position: relative; right: -220px; top: -100PX;"
										required> <input type="button" class="btn2 textbox"
										style="width: 100px; height: 30px; position: relative; top: -100px; right: -280px;"
										id="checkBtn" class="" value="중복확인" onclick="idDuplication();">
									<hr style="margin-top: -76px; margin-bottom: -3px;">
								</div>
							</div>
							...
							<div class="col-md-10"">
								<div class="form-group" style="margin-bottom: -21px;">
									<div class="s"
										...
										<div class="red">
											* <label class="font">성명</label>
										</div>

									</div>

									<input type="text" class="textbox" placeholder="" id="name"
										name="name" class="name"
										style="position: relative; right: -220px; top: -15px;">
							...
							<div class="col-md-10">
								<div class="form-group"
									...
									<input type="radio"
										style="width: 15px; height: 15px; position: relative; right: -230px; top: -30px;"
										name="sex" value="남자"> <label
										style="font-size: 15px; position: relative; right: -230px; top: -30px;">남자</label>

									<input type="radio"
										style="width: 15px; height: 15px; position: relative; right: -230px; top: -30px;"
										name="sex" value="여자"> <label
										style="font-size: 15px; position: relative; right: -230px; top: -30px;">여자</label>
								</div>
								<hr>
							</div>
							...
							<div class="col-md-10">
								<div class="form-group"
									...
									<input type="text" id="email1" class="textbox" name="email1"
										style="width: 170px; position: relative; top: -50px; right: -220px;"
										required> <label
										style="position: relative; top: -50px; right: -225px;">@</label>
									<input type="text" id="email2" class="textbox" name="email2"
										style="width: 170px; position: relative; right: -225px; top: -50px;">

									<select id="emailSelection" name="emailSelection"
										style="width: 120px; height: 33px; position: relative; right: -240px; top: -50px; border: 1px solid black; border-radius: 4px;">
										<option>직접입력</option>
								...
								<P style="position: relative; bottom: -20px; right: -225px;">*
									이메일은 아이디를 찾을때 필요합니다.</P>
							...
							<div class="col-md-10" style="margin-bottom: 300px;">
								...
								<div class="form-group ">
									...
									style="position: relative; right: -250px; border-color: #527eee;background-color: #5e8afb; color: white; width: 70px; height: 60px;">




									<a href="../main/main.do"><input type="button" value="가입취소"
									style="position: relative; right: -280px; border-color: #527eee;background-color: #5e8afb; color: white; width:70px; height: 60px;"></a>
								</div>
