            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="logo_area text-center">
                        <a href="main.do" class="yummy-logo">dudud요리보고 조리보고</a>
                    </div>
                </div>
            </div>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="archive.do">예약</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">마이페이지</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="contact.do">실시간 채팅</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
...
--%>
    ...
    <div class="instargram_area section_padding_100_0 clearfix" id="portfolio">
                ...
                <div class="col-12">
                    <div class="footer-content">
                        ...
                        <div class="footer-logo-area text-center">
                            <a href="main.do" class="yummy-logo">Yummy Blog</a>
                        </div>
                        <!-- Menu Area Start -->
                        <nav class="navbar navbar-expand-lg">
