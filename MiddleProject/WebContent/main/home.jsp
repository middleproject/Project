    	...
    	<div class="container">
    		...
    		<c:forEach var="vo" items="${rlist }" varStatus="s">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="../recipe/recipe_detail.do?no=${vo.no}" class="img-prod"><img class="img-fluid" src="images/product-1.jpg" alt="Colorlib Template">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">${vo.summary }</span></p>
		    					</div>
	    					</div>
